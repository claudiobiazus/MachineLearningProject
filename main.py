...
if __name__ == "__main__":
    ...
    # # FER-2013
    # # -------------------------
    FER_PATH = "/home/pedro/Datasets/FER"
    TRAIN = FER_PATH + "/train_features_model.csv"
    TEST = FER_PATH + "/test_features_model.csv"
    ...
    os.makedirs(OUTPUT_DIR, exist_ok=True)
    print("TESTE DE CLASSIFICADORES USANDO O DATASET FER")
